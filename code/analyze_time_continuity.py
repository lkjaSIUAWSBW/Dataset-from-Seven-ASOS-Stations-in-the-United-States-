...
# Explicit common study period, inclusive at both ends. Change these two
# values only if the study period in the manuscript is changed as well.
...
def summarize(path: Path, total_slots: int) -> dict[str, object]:
    ...
    # Close a run or gap that reaches the end of the study period.
